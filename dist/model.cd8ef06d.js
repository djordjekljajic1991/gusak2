      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            _context.next = 6;
            return Promise.race([fetchPro, timeout(20)]);
...
exports.URL_TODAY = exports.URL_FORECAST = void 0;
var URL_FORECAST = "https://aerisweather1.p.rapidapi.com/forecasts/banja%20luka,%20bih";
exports.URL_FORECAST = URL_FORECAST;
var URL_TODAY = "https://aerisweather1.p.rapidapi.com/observations/banja luka,bih";
exports.URL_TODAY = URL_TODAY;
...
exports.state = exports.loadWeather = exports.loadForecast = exports.galleryFunction = exports.galleryData = void 0;
...
var createWeatherObject = function createWeatherObject(data) {
  var weather = data.response.ob;
  var icon2x = "".concat(data.response.ob.icon.split(".")[0], "@2x.png");
  return {
    tempC: weather.tempC,
...
var loadWeather = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _helpers.getJSON)("".concat(_config.URL_TODAY));
...
var createForecastObject = function createForecastObject(data) {
  var days = data.response[0].periods.map(function (day) {
    var icon2x = "".concat(day.icon.split(".")[0], "@2x.png");
    return {
...
var loadForecast = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return (0, _helpers.getJSON)("".concat(_config.URL_FORECAST));
...
var weatherTodayDetails = function weatherTodayDetails() {
  var detailsBox = document.querySelector(".today--details");
  var markup = " <li>Vjetar: ".concat(state.weather.windSpeedKPH, " km/h</li>\n  <li>Vjer. padavina: ").concat(state.forecast.days[0].pop, "%</li>\n  <li>Vla\u017Enost: ").concat(state.weather.humidity, "%</li>\n  <li>Vidljivost: ").concat(Math.round(state.weather.visibilityKM), " km</li>\n  <li>Pritisak: ").concat(state.weather.pressureMB, " mB</li>");
  detailsBox.insertAdjacentHTML("afterbegin", markup);
};

var createWeatherIcon = function createWeatherIcon(data, day) {
  var iconEL = document.querySelector(day);
  var markup; //const markup = `<img class="weather"  srcset="./src/img/icons/weather/${state.weather.icon} 1x,
  //./src/img/icons/weather/${state.weather.icon2x} 2x"></img>`;

  if (data === state.weather) {
    markup = "<img class=\"weather\"  src=\"/src/img/icons/weather/".concat(data.icon2x, "\"></img>\n    <div class=\"tempa\" >\n    <p class=\"temp\" >").concat(data.tempC, "\xB0C</p>\n    </div>\n    ");
  } else {
...
var createWeatherDetails = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(data, day) {
    var detailsBox, markup;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            try {
              detailsBox = document.querySelector(day);
  ...
  return function createWeatherDetails(_x, _x2) {
...
galleryFunction(); /////smooth scroling

document.querySelector(".navigation-lists").addEventListener("click", function (e) {
  e.preventDefault();
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/js/model.js"], null)
//# sourceMappingURL=/model.cd8ef06d.js.map